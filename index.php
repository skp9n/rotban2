...
<body style="background-color: #2b3089;color: #b9b8b8;">
  ...
  <form id="rotban_form">
    <div class="text-center"><input class="form-control form-control-lg"  type="text" id="cid" placeholder="VATSIM-ID" name="cid" inputmode="numeric" style="font-family: 'PT Sans',  sans-serif;width:5cm;" minlength="6" maxlength="7"></div>
