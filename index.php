...
<body style="background-color: #2b3089;color: #b9b8b8;">
  ...
  <form id="rotban_form">
    <div class="text-center"><input class="form-control form-control-lg"  type="text" id="cid" placeholder="VATSIM-ID" name="cid" inputmode="numeric" style="font-family: 'PT Sans', width:5cm, sans-serif;" minlength="6" maxlength="7"></div>
