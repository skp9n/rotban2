...
<body style="background-color: #2b3089;color: #b9b8b8;">
    ...
    <div class="table-responsive table-borderless" style="align-items: center;margin: auto;width: 40%;">
        <table class="table-responsive table-borderless" style="align-items: center;margin: auto;width: 40%;">
            <thead>
                <tr>
...
<?php
  if(mysqli_num_rows($images_result) > 0){
    while($row = mysqli_fetch_array($images_result)){
      echo "<tr>";
        echo '<td style="color: #b9b8b8;padding:10px; width: 10%;"><div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1"><label class="form-check-label" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" for="formCheck-1">' . $row['description'] . '</label></div></td>';
