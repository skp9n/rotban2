                    ...
                    foreach ($images as $image) {
                        if ($image['id_group'] == $group['id']) {
                            ...
                            if ($image['cid_required'] != 0) {
                                echo '<div class="col"><img border=2 max-height="80px" max-width="400px" src="' . str_replace("\$cid", "", $uri) . '"/></div>';
                            } else {
                                echo '<div class="col"><img border=2 max-height="80px" max-width="400px" src="' . $uri . '"/></div>';
                            }
                            echo '</div>';
                        }
                    }
