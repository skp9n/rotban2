          ...
          <tbody>
            ...
            if(mysqli_num_rows($images_result) > 0){
              while($row = mysqli_fetch_array($images_result)){
                echo "<tr>";
                echo '<td style="color: #b9b8b8;padding:1cm; width: 10%;"><div class="form-check"><input class="form-check-input" type="checkbox" id="img' . $row['id'] . '"><label class="form-check-label" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" for="formCheck-1">' . $row['description'] . '</label></div></td>';
